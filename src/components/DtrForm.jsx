      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-5 items-end">
        ...
        <div className="xl:col-span-2 flex flex-col sm:flex-row gap-5 items-end">
          ...
          <button type="submit" disabled={loading} 
            className={`w-full sm:w-auto font-bold px-8 py-3.5 rounded-xl transition-all active:scale-95 h-[48px] whitespace-nowrap shadow-lg ${successStatus ? 'bg-emerald-500 text-white shadow-emerald-500/20' : 'bg-slate-900 dark:bg-cyan-500 hover:bg-cyan-600 dark:hover:bg-cyan-400 text-white dark:text-slate-950 shadow-slate-900/10'}`}>
